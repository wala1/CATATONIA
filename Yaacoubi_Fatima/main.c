...
{   
    ...
    SDL_Surface *screen=NULL, *p[15]= {NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL},
*background=NULL;
    ...
    p[28]=IMG_Load("walk1.png");
    p[29]=IMG_Load("walk2.png");
    p[30]=IMG_Load("walk3.png");
    p[31]=IMG_Load("walk4.png");
    p[32]=IMG_Load("walk5.png");
    p[33]=IMG_Load("walk6.png");
    p[34]=IMG_Load("walki1.png");
    p[35]=IMG_Load("walki2.png");
    p[36]=IMG_Load("walki3.png");
    p[37]=IMG_Load("walki4.png");
